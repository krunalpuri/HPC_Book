...
%
%\subsection{Big Data at HPC Wales \cite{kashyap2015big}.}
%In a parallel approach to take advantage of computing power of supercomputers along with Hadoop's capabilities in managing distributed resources, HPC Wales launched the Big Data at HPC Wales project. The project exploits YARN to couple with HPC tasks, which conventionally would use MPI, OpenMP, CUDA, etc.\\
%
% HPC Wales is a supercomputing center with around 17,000 cores distributed % in six campuses. The Big Data at HPC Wales proposed architecture tries to % take advantage of best of the two worlds of HPC and ABDS. The proposed % architecture is based on a series of design choices as follows.

%%\textbf{Job Scheduling:} An API enabled to understand multiple languages takes the job submission enabling non-HPC Wales users to submit jobs
\newpage
...
\newpage
\subsection*{IBM Watson for Data Analytics} %NEEDS PARAPHRASING
